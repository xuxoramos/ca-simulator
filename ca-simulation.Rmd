...
date: "`r Sys.Date()`"
author: "Jesús Ramos / @xuxoramos / jesus[at]datank[dot]ai"
output:
...
kable(head(summary_diff_clust, 10))
```
...
- [Datank.ai](https://datank.ai) por los recursos otorgados para su ejecución.
